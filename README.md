...
1.	Ensure Python 3.x is installed on your machine. You can download it from python.org.
...
1.	Run the program.
2.	Enter any password you want to test when prompted.
3.	If the password is not strong, the program will ask how many attempts you want to retry.
4.	Enter a stronger password on each retry attempt until you receive a "STRONG" rating or exhaust your attempts.
5.	Observe the feedback messages to understand what you can improve in your password.
6.	Test with various passwords to cover different cases (short passwords, passwords lacking uppercase letters, missing digits, etc.).
